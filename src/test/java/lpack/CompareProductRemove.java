...
public class CompareProductRemove {
	 WebDriver driver;
	  ...
	  public void verifyHomePageLoadsCorrectly() throws InterruptedException {
	      ...
	      Assert.assertFalse(driver.getPageSource().contains("You removed product Radiant Tee from the comparison list."), "Compare Products Remove passed.");
